...
LABEL org.opencontainers.image.authors="FNNDSC <dev@babyMRI.org>" \
      org.opencontainers.image.title="A ChRIS plugin to query a remote PACS" \
      org.opencontainers.image.description="A ChRIS plugin to query PACS using pfdcm"

ARG SRCDIR=/usr/local/src/pl-pacs_query
WORKDIR ${SRCDIR}
